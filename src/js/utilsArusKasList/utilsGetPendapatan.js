import { pasangListenerHapus } from "../updatedelete/udpendapatan/delete";
export const panggilApiGetPendapatan = async (endpoint, options = {}) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            outputPendBulIni += `<p><span class="text-green">${Number(data.selisihPendapatan).toLocaleString('id-ID', { style: 'currency', currency: 'IDR' })}</span> Rb lebih tinggi dibanding bulan lalu</p>`;
