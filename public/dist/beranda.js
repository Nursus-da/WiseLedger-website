...
})({"5Q5XP":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7eb82dfdc7f889e3";
"use strict";
...
},{}],"dkKhf":[function(require,module,exports,__globalThis) {
var _styleCss = require("./css/dashboard/style.css");
var _logoutJs = require("./js/logout.js");
var _getTokenJs = require("./js/utilsAuth/getToken.js");
var _utilsJs = require("./js/utilsAuth/utils.js");
var _berandaJs = require("./js/authAndformsetup/beranda.js");
var _utilsJs1 = require("./js/plugin/utils.js");
var _berandaPluginJs = require("./js/plugin/berandaPlugin.js");

},{"./css/dashboard/style.css":"juE4g","./js/logout.js":"bVZ4E","./js/utilsAuth/getToken.js":"eRsDT","./js/utilsAuth/utils.js":"lWhpu","./js/authAndformsetup/beranda.js":"4d1ht","./js/plugin/utils.js":"kyNOh","./js/plugin/berandaPlugin.js":"8YkUq"}],"juE4g":[function() {},{}],"bVZ4E":[function(require,module,exports,__globalThis) {
...
function dropdown() {
    ...
    document.addEventListener("click", function(event) {
        if (!userBtn.contains(event.target)) dropdown.classList.remove("show");
    });
}
function Logout() {
    localStorage.clear();
...
},{}],"eRsDT":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4d1ht":[function(require,module,exports,__globalThis) {
var _getToken = require("../utilsAuth/getToken");
var _utils = require("../utilsAuth/utils");
const authBeranda = async function auth() {
    await (0, _utils.panggilApi)('/beranda/auth', {
        method: 'GET',
        headers: {
...
},{"../utilsAuth/getToken":"eRsDT","../utilsAuth/utils":"lWhpu"}],"kyNOh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "panggilApiForPlugin", ()=>panggilApiForPlugin);
    ...
    try {
        ...
        if (response.ok) {
            ...
            inventarisItems.forEach((item)=>{
                ...
                div.textContent = item.produk + ' : ' + item.stok + ' Pcs,' + " Harga Satuan : " + Number(item.harga).toLocaleString('id-ID', {
                    style: 'currency',
                    currency: 'IDR'
                });
            ...
            new (0, _autoDefault.default)(ctxPie, {
                type: 'pie',
                data: {
                    labels: [
                        'Keuntungan',
            ...
            new (0, _autoDefault.default)(ctxLine, {
                type: 'line',
                data: {
                    labels: labelBulan,
                    datasets: [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","chart.js/auto":"d8NN9","chartjs-plugin-datalabels":"2HIEm"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunks/helpers.dataset.js":"bmLCi","@kurkle/color":"2aojw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bmLCi":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.5.1
 * https://www.chartjs.org
 * (c) 2025 Chart.js Contributors
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2HIEm":[function(require,module,exports,__globalThis) {
/*!
...
},{"chart.js/helpers":"dxsY3","chart.js":"ipU8D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dxsY3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helpersJs = require("../dist/helpers.js");
parcelHelpers.exportAll(_helpersJs, exports);

},{"../dist/helpers.js":"2ZYxS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2ZYxS":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.5.1
 * https://www.chartjs.org
 * (c) 2025 Chart.js Contributors
...
},{"./chunks/helpers.dataset.js":"bmLCi","@kurkle/color":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8YkUq":[function(require,module,exports,__globalThis) {
const { panggilApiForPlugin } = require("d53abfbc22db4dd5");
const { token } = require("b0a246c98dc63a8e");
...
},{"d53abfbc22db4dd5":"kyNOh","b0a246c98dc63a8e":"eRsDT"}]},["5Q5XP","dkKhf"], "dkKhf", "parcelRequiref3b1", {})
