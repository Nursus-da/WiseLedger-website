...
})({"5CUPT":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b3264c582fc09d34";
"use strict";
...
},{}],"1ajiU":[function(require,module,exports,__globalThis) {
...
var _arusKasJs = require("./js/authAndformsetup/arus-kas.js");
var _utilsGetAruskasJs = require("./js/utilsArusKasList/utilsGetAruskas.js");
var _getArusKasJs = require("./js/aruskaslist/getArusKas.js");

},{"./css/dashboard/style.css":"juE4g","./js/utilsAuth/getToken.js":"eRsDT","./js/utilsAuth/utils.js":"lWhpu","./js/authAndformsetup/arus-kas.js":"bn6DB","./js/utilsArusKasList/utilsGetAruskas.js":"etcgC","./js/aruskaslist/getArusKas.js":"3OWmA"}],"juE4g":[function() {},{}],"eRsDT":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bn6DB":[function(require,module,exports,__globalThis) {
var _getToken = require("../utilsAuth/getToken");
var _utils = require("../utilsAuth/utils");
const authArusKas = async function auth() {
    await (0, _utils.panggilApi)('/arus-kas/auth', {
        method: 'GET',
        headers: {
...
},{"../utilsAuth/getToken":"eRsDT","../utilsAuth/utils":"lWhpu"}],"etcgC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "panggilApiGetAruskas", ()=>panggilApiGetAruskas);
const panggilApiGetAruskas = async (endpoint, options = {})=>{
    try {
        ...
        if (response.ok) {
            ...
            cardAruskasValue.textContent = Number(data.labaBersih).toLocaleString('id-ID', {
                style: 'currency',
                currency: 'IDR'
            });
            // output
            ...
            cardWrapperValuePendapatan.textContent = Number(data.pendapatan).toLocaleString('id-ID', {
                style: 'currency',
                currency: 'IDR'
            });
            // wrapper subtext
            ...
            cardWrapperValuePengeluaran.textContent = Number(data.pengeluaran).toLocaleString('id-ID', {
                style: 'currency',
                currency: 'IDR'
            });
            // wrapper subtext
            ...
            data.arusKas.forEach((item)=>{
                ...
                tablesOutput += `<td>${Number(item.jumlah).toLocaleString('id-ID', {
                    style: 'currency',
                    currency: 'IDR'
                })}</td>`;
                tablesOutput += "</tr>";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3OWmA":[function(require,module,exports,__globalThis) {
var _getToken = require("../utilsAuth/getToken");
var _utilsGetAruskas = require("../utilsArusKasList/utilsGetAruskas");
const verifyAruskas = async function get() {
    await (0, _utilsGetAruskas.panggilApiGetAruskas)('/arus-kas/list', {
        method: "GET",
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${(0, _getToken.token)}`
...
},{"../utilsAuth/getToken":"eRsDT","../utilsArusKasList/utilsGetAruskas":"etcgC"}]},["5CUPT","1ajiU"], "1ajiU", "parcelRequiref3b1", {})

//# sourceMappingURL=aruskas.js.map
